    ...
    return (
        <div className="drop">
            <Container className="main">
                ...
                <Row>
                    <Col>
                        <Image src="#" rounded alt='Cody Tracey - Developer Extraordinaire' />
                    </Col>
                    <Col>
                        My name is Cody Tracey, and thank you for taking the time to view my
                        ...
                        <br />
                        I am proficient in: HTML5, CSS3, JavaScript, jQuery, Bootstrap, NodeJS, MySQL, MongoDB, MySQL, Express, ReactJS.</Col>
                </Row>
            </Container>
        </div>
